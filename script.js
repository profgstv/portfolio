...
const projectsList = {
    ...
    src: ["./src/img/proj-p5-digimon.png", "./src/img/proj-p5-egito.png", "./src/img/proj-p5-monalisa.png", "./src/img/proj-p5-nave-desvio.png", "./src/img/proj-p5-palavra.png", "./src/img/proj-p5-pong.png", "./src/img/proj-p5-radio.png", "./src/img/proj-p5-sim-coord-controle-drift.png", "./src/img/proj-p5-spinning-scratch.png", "./src/img/proj-scratch-digimon-card-battle.png", "./src/img/proj-scratch-pong.png", "./src/img/proj-scratch-salve-o-planeta.png", "./src/img/proj-tinkercad-carrinho-drift.png", "./src/img/proj-tinkercad-carrinho-eixo.png", "./src/img/proj-github-ciebp-minimal.png", "./src/img/proj-makecode-wineglass.png", "./src/img/proj-makecode-radio-pointers.png", "./src/img/proj-makecode-radio-shooters.png", "./src/img/proj-github-red-alert.png", "./src/img/proj-github-catflix.png", "./src/img/proj-github-catflix-plus.png"],
